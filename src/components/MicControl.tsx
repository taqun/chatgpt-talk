...
export const MicControl: FC<MicControlProps> = ({
  isListening,
  hasSound,
  onStartListening,
  onStopListening,
  ...
  return (
    <div className={styles.container}>
      <div className={styles.iconContainer}>
        <p className={isListening ? styles.isListening : styles.isNotListening}>
          ●
        </p>
        <p>
          <svg
            className={hasSound ? styles.hasSound : styles.hasNotSound}
            height="21px"
            version="1.1"
            viewBox="0 0 14 21"
            width="14px"
